...
* The original package name 'com.microsevice.currency-conversion-service' is invalid and this project uses 'com.microsevice.currencyconversionservice' instead.
